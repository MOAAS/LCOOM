...
/**
 * @brief Contains information about the received/sent information through the UART
 * 
 */
typedef struct {
    Queue* toSend;      ///< FIFO with the characters to send through the UART
    Queue* received;    ///< FIFO with the characters received through the UART that have yet to be processed
} UART_Int_Info;
