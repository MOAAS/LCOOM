...
/**
 * @brief Enumerates all the types of emotes
 * 
 */
typedef enum {
    Hello = 0,      ///< "Hello" emote
    GoodGame = 1,   ///< "Good Game" emote
    ThankYou = 2,   ///< "Thank You" emote
    YouWelcome = 3, ///< "You're Welcome" emote
    GoodLuck = 4    ///< "Good Luck" emote
} Emote;
