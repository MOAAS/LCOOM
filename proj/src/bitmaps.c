...
void loadBitmaps(const char* folderPath) {
    ...
    cursor_shape = loadBitmap(folderPath, "cursor_shape.bmp");
    ...
    powerup7_bmp = loadBitmap(folderPath, "powerup7.bmp");
    powerup8_bmp = loadBitmap(folderPath, "powerup8.bmp");
    powerup9_bmp = loadBitmap(folderPath, "powerup9.bmp");

    hpbar_bmp = loadBitmap(folderPath, "hp_bar.bmp");
    hpbar_hidden_bmp = loadBitmap(folderPath, "hp_bar_hidden.bmp");
